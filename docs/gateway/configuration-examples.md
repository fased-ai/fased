---
summary: "Schema-accurate configuration examples for common local, hosting, and channel setups."
read_when:
  - Learning how to configure Fased
...
```json5
{
  ...
  session: {
    ...
    store: "~/.fased/agents/default/sessions/sessions.json",
    maintenance: {
      mode: "warn",
      pruneAfter: "30d",
      maxEntries: 500,
...
- Use **Agent > Models** for provider setup. See [Troubleshooting](/gateway/troubleshooting) for deeper diagnostics.
