...
read_when: "You hit a sandbox block or see a tool/elevated refusal and want the exact config key to change."
status: active
---

# Sandbox vs Tool Policy vs Elevated

Fased has three related (but different) controls:
...
Use the inspector to see what Fased is _actually_ doing:
