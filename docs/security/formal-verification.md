...
summary: Machine-checked security models for Fased’s highest-risk paths.
read_when:
  - Reviewing formal security model claims and limits
...
Models are maintained as optional external research artifacts:
[vignesh07/fased-formal-models](https://github.com/vignesh07/fased-formal-models).
The Fased TypeScript code and tests in this repository remain the implementation
source of truth.
...
```bash
git clone https://github.com/vignesh07/fased-formal-models
