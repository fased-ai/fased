...
<Tabs>
  <Tab title="Ubuntu">
    Recommended for the first hosted setup. Use this for Ubuntu or Debian VPS
    images:
  ...
  <Tab title="Alpine">
    Alpine can install Fased, but hosted service/firewall hardening depends on
    the provider image and init system.
