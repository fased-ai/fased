...
If you have multiple profiles/state dirs (e.g. `~/.fased-main`, `~/.fased-work`), archive each.
...
At this stage, it’s OK if onboarding creates a fresh `~/.fased/` — you will overwrite it in the next step.
