---
summary: "Hubs that link to every Fased doc"
read_when:
...
<Note>
If you are new to Fased, start with [Getting Started](/start/getting-started).
</Note>
...
- [Wizard](/start/wizard)
- [Setup](/start/setup)
- [Dashboard (local Gateway)](http://localhost:18789/)
- [Help](/help)
- [Docs directory](/start/docs-directory)
- [Configuration](/gateway/configuration)
- [Configuration examples](/gateway/configuration-examples)
- [Fased assistant](/start/fased)
...
## Agent models + ingress

- [Chat channels hub](/channels)
- [Models to Agents](/start/provider-agent-chat-flow)
