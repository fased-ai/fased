---
summary: "Fased macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a Fased macOS release
...
Use this page when you are publishing signed macOS app artifacts. Sparkle updates are a release-maintainer path, not the default public install flow while the repo-backed installer remains primary.
