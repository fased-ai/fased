---
summary: "Location command for nodes (location.get), permission modes, and Agent access"
read_when:
  - Adding location node support or permissions UI
  - Troubleshooting Agent location tool access
...
- **Advanced > Nodes** is diagnostic only; device settings own the location
  permission, and **Agent > Tools** controls whether an Agent can use the node
  location tool.
