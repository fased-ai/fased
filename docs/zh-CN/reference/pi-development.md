...
x-i18n:
  ...
  source_path: reference/pi-development.md
  workflow: 15
---

# Pi 开发工作流程

本指南总结了在 Fased 中开发 Pi 集成的合理工作流程。
...
```bash
FASED_LIVE_TEST=1 pnpm test -- src/agents/pi-embedded-runner-extraparams.live.test.ts
```
...
状态存储在 Fased 状态目录下。默认为 `~/.fased`。如果设置了 `FASED_STATE_DIR`，则使用该目录。
...
- https://docs.fased.ai/testing
- https://docs.fased.ai/start/getting-started
