---
summary: "OpenProse: .prose workflows, slash commands, and state in Fased"
read_when:
...
Dev/local checkout: `fased plugins install ./extensions/open-prose`
...
## Fased runtime mapping

OpenProse programs map to Fased primitives:

| OpenProse concept         | Fased tool       |
| ------------------------- | ---------------- |
