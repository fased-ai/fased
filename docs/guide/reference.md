...
summary: "Look up a specific command or configuration."
---

The main guide covers ordinary use. These references provide detail when you need it; features depend on the installed release.

| Topic                      | Reference                                                                                        |
| -------------------------- | ------------------------------------------------------------------------------------------------ |
| Installation and platforms | [Installer](/install/installer), [macOS](/platforms/macos), [Windows / WSL2](/platforms/windows) |
| Commands                   | [CLI](/cli/index)                                                                                |
| Browser control panel      | [Control UI](/web/control-ui)                                                                    |
| Models                     | [Providers](/providers/index)                                                                    |
