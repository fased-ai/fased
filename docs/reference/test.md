...
The script prints min/median/max latency for the configured providers. Treat
local results as a point-in-time comparison; provider latency varies by account,
region, model load, and network path.
