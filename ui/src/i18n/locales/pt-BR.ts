...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.fased/fased.json com segurança.",
  ...
  overview: {
    ...
    notes: {
      ...
      cronTitle: "Lembretes de tarefas",
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando fased dashboard --no-open no desktop.",
    },
    insecure: {
