...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.fased/fased.json sicher bearbeiten.",
  ...
  overview: {
    ...
    notes: {
      ...
      cronTitle: "Aufgaben-Erinnerungen",
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von fased dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
