...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  const injected = (
    window as typeof window & { __FASED_INJECTED_IDENTITY__?: Partial<AssistantIdentity> | null }
  ).__FASED_INJECTED_IDENTITY__;
  return normalizeAssistantIdentity(injected);
}
