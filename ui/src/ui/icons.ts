...
export const icons = {
  ...
  network: html`
    <svg viewBox="0 0 24 24">
      ...
      <rect x="3" y="10" width="5" height="5" rx="1.5" />
      <rect x="16" y="17" width="5" height="5" rx="1.5" />
      <path d="M8 12.5h4.5a3 3 0 0 0 3-3V8" />
      <path d="M8 12.5h4.5a3 3 0 0 1 3 3V17" />
    </svg>
  `,
  store: html`
    <svg viewBox="0 0 24 24">
      ...
      <path d="M9 21v-7h6v7" />
      <path d="M7 9v1a2 2 0 0 0 4 0V9" />
      <path d="M13 9v1a2 2 0 0 0 4 0V9" />
    </svg>
  `,
  radio: html`
    <svg viewBox="0 0 24 24">
  ...
  bot: html`
    <svg viewBox="0 0 24 24">
      ...
      <path d="M2 14h2" stroke-linecap="round" />
      <path d="M20 14h2" stroke-linecap="round" />
      <path d="M9 13h.01" stroke-linecap="round" />
      <path d="M15 13h.01" stroke-linecap="round" />
  ...
  bell: html`
    <svg viewBox="0 0 24 24">
      ...
      <path
        d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .738-1.674C19.41 13.86 18 12.2 18 8a6 6 0 1 0-12 0c0 4.2-1.41 5.86-2.738 7.326"
      />
    </svg>
  `,
  brain: html`
  ...
  wallet: html`
    <svg viewBox="0 0 24 24">
      <path
        d="M19 7V5a2 2 0 0 0-2-2H5a3 3 0 0 0 0 6h14a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H5a3 3 0 0 1-3-3V6"
      />
      <path d="M16 14h.01" />
    </svg>
  `,
  hand: html`
    <svg viewBox="0 0 24 24">
      ...
      <path
        d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.8-1.2-6.2-3.3L2.6 14a2 2 0 0 1 3.4-2L8 15"
      />
    </svg>
  `,
  lock: html`
  ...
  shield: html`
    <svg viewBox="0 0 24 24">
      <path
        d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67 0C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.8 17 5 19 5a1 1 0 0 1 1 1z"
      />
    </svg>
  `,
  send: html`
