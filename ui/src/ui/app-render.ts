          ...
          state.tab === "federation" || state.tab === "marketplace"
            ? federationView
              ? federationView.renderFederation({
                  ...
                  walletStatus: state.walletStatus,
                  walletCustodyByWalletId: state.walletCustodyByWalletId,
                  walletNamedWallets: state.walletNamedWallets,
                  defaultWalletId: state.walletDefaultWalletId,
                  miningAttachedWalletId: state.miningAttachedWalletId,
                  miningProfile: state.miningProfile,
          ...
          state.tab === "wallet"
            ? walletView
              ? walletView.renderWallet({
                  ...
                  status: state.walletStatus,
                  custodyByWalletId: state.walletCustodyByWalletId,
                  namedWallets: state.walletNamedWallets,
                  ...
                  securitySetupWalletId: state.walletSecuritySetupWalletId,
                  securitySetupRole: state.walletSecuritySetupRole,
                  ...
                  clientSecuritySupport: state.walletCustodyClientCompatibility,
                  clientSecuritySupportError: state.walletCustodyClientCompatibilityError,
                  custodyDeviceShare: state.walletCustodyDeviceShare,
                  custodyRecoveryShare: state.walletCustodyRecoveryShare,
                  custodyRecoveryInput: state.walletCustodyRecoveryInput,
                  custodyEnrollLabel: state.walletCustodyEnrollLabel,
                  custodyEnrolledDeviceShare: state.walletCustodyEnrolledDeviceShare,
                  custodyRememberDeviceShare: state.walletCustodyRememberDeviceShare,
                  custodyDeviceShareStored: state.walletCustodyDeviceShareStored,
                  custodyUnlockMinutes: state.walletCustodyUnlockMinutes,
                  ...
                  onCustodyDeviceShareChange: (next) =>
                    state.handleWalletCustodyDeviceShareChange(next),
                  onCustodyRecoveryInputChange: (next) =>
                    state.handleWalletCustodyRecoveryInputChange(next),
                  onCustodyEnrollLabelChange: (next) =>
                    state.handleWalletCustodyEnrollLabelChange(next),
                  onCustodyRememberChange: (next) => state.handleWalletCustodyRememberToggle(next),
                  onCustodyUnlockMinutesChange: (next) =>
                    state.handleWalletCustodyUnlockMinutesChange(next),
                  onInitializeCustody: () => state.handleWalletInitializeCustody(),
                  onEnrollCustodyDevice: () => state.handleWalletEnrollCustodyDevice(),
                  onRevokeCustodyDevice: (deviceId) =>
                    state.handleWalletRevokeCustodyDevice(deviceId),
                  onDisableCustody: (walletId) => state.handleWalletDisableCustody(walletId),
                  onRecoverCustody: () => state.handleWalletRecoverCustody(),
                  onUnlockCustody: () => state.handleWalletUnlockCustody(),
                  onLockCustody: () => state.handleWalletLockCustody(),
                  onForgetCustodyDeviceShare: () => state.handleWalletForgetCustodyDeviceShare(),
                  onDownloadDeviceShare: () => state.handleWalletDownloadCustodyDeviceShare(),
                  onDownloadEnrolledDeviceShare: () =>
                    state.handleWalletDownloadEnrolledDeviceShare(),
                  onDownloadRecoveryKit: () => state.handleWalletDownloadCustodyRecoveryKit(),
                  onPrintRecoveryKit: () => state.handleWalletPrintCustodyRecoveryKit(),
                  onPrintEnrolledDeviceShare: () => state.handleWalletPrintEnrolledDeviceShare(),
