...
const DIARY_START_RE = /<!--\s*fased:dreaming:diary:start\s*-->/;
const DIARY_END_RE = /<!--\s*fased:dreaming:diary:end\s*-->/;
...
const dreamAvatar = html`
  <svg viewBox="0 0 120 120" fill="none">
    <defs>
      <linearGradient id="dream-avatar-g" x1="0%" y1="0%" x2="100%" y2="100%">
...
function renderScene(props: DreamingProps, idle: boolean, dreamText: string) {
  return html`
    <section class="dreams ${idle ? "dreams--idle" : ""}">
      ...
      <div class="dreams__avatar">${dreamAvatar}</div>
