...
export function renderSlackCard(params: {
  ...
  slackAccounts: ChannelAccountSnapshot[];
  accountCountLabel: unknown;
}) {
  const { props, slack, slackAccounts, accountCountLabel } = params;
  ...
  return html`
    <div class="card">
      ...
      ${renderChannelRoutePanel({ props, channelId: "slack", accounts: slackAccounts })}
      ...
      ${renderChannelConfigSection({
        ...
        props,
        configured:
          slack?.configured === true || slackAccounts.some((account) => account.configured),
      })}
