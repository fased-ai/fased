...
export function renderNostrProfileForm(params: {
      ...
      return html`
        <div class="form-field" style="margin-bottom: 12px;">
          ...
          <textarea
            ...
            rows="3"
            style="width: 100%; padding: 10px 12px; border: 1px solid var(--border); border-radius: 12px; resize: vertical; font-family: inherit; background: var(--bg); color: var(--text);"
            @input=${(e: InputEvent) => {
    ...
    return html`
      <div class="form-field" style="margin-bottom: 12px;">
        ...
        <input
          ...
          style="width: 100%; padding: 10px 12px; border: 1px solid var(--border); border-radius: 12px; background: var(--bg); color: var(--text);"
          @input=${(e: InputEvent) => {
  ...
  return html`
    <div
      ...
      style="padding: 16px; background: var(--secondary); border: 1px solid var(--border); border-radius: 16px; margin-top: 12px;"
    >
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--muted);">Advanced</div>
