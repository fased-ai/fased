...
export function renderTelegramCard(params: {
  ...
  return html`
    <div class="card">
      ...
      ${renderChannelRoutePanel({ props, channelId: "telegram", accounts: telegramAccounts })}
      ...
      ${renderChannelConfigSection({
        ...
        props,
        configured:
          telegram?.configured === true || telegramAccounts.some((account) => account.configured),
      })}
      ${
        hasMultipleAccounts
          ? nothing
