export const usageStylesPart1 = `
  ...
  .usage-primary-btn {
    ...
    box-shadow: inset 0 -1px 0 rgba(0, 0, 0, 0.16), 0 0 0 1px color-mix(in srgb, var(--accent) 18%, transparent);
  }
  .btn.usage-primary-btn {
    background: linear-gradient(180deg, var(--accent), var(--accent-hover)) !important;
    border-color: color-mix(in srgb, var(--accent) 80%, var(--border)) !important;
    color: var(--accent-foreground) !important;
  }
  .usage-primary-btn:hover {
    background: linear-gradient(180deg, var(--accent-hover), var(--accent)) !important;
    border-color: color-mix(in srgb, var(--accent-hover) 84%, var(--border));
  }
  .btn.usage-primary-btn:hover {
    background: linear-gradient(180deg, var(--accent-hover), var(--accent)) !important;
    border-color: color-mix(in srgb, var(--accent-hover) 84%, var(--border)) !important;
  }
  ...
  .usage-primary-btn[disabled] {
    background: color-mix(in srgb, var(--accent-subtle) 88%, transparent) !important;
  ...
  .usage-header.pinned {
    ...
    top: 12px;
    z-index: 6;
    background: linear-gradient(180deg, var(--chrome), var(--chrome-strong));
  ...
  .usage-mosaic-section {
    background: linear-gradient(180deg, var(--bg-subtle), var(--panel-strong));
    border: 1px solid var(--border);
    border-radius: 16px;
    padding: 12px;
  }
