...
export function renderLoginGate(state: AppViewState) {
  ...
  const brandLogoSrc = basePath ? `${basePath}/fased-logo.svg` : "fased-logo.svg";

  return html`
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${brandLogoSrc} alt=${FASED_BRAND_NAME} />
          <div class="login-gate__title">${FASED_BRAND_NAME}</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="FASED_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>
              ${t("overview.connection.step1")}${renderConnectCommand("fased gateway run")}
            </li>
            <li>${t("overview.connection.step2")} ${renderConnectCommand("fased dashboard")}</li>
