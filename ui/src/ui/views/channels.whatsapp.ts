...
export function renderWhatsAppCard(params: {
  ...
  const { props, whatsapp, whatsappAccounts, accountCountLabel } = params;
  ...
  return html`
    <div class="card">
      ...
      ${renderChannelRoutePanel({ props, channelId: "whatsapp", accounts: whatsappAccounts })}
      ...
      ${renderChannelRuntimeControls({ props, channelId: "whatsapp", running: whatsapp?.running })}

      ${renderChannelConfigSection({
        channelId: "whatsapp",
        props,
        configured: whatsapp?.configured === true,
      })}
    </div>
  `;
}
