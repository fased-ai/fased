...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  ...
  acp: {
    label: "ACP Runtime",
    description: "Advanced external coding harness runtime and dispatch settings",
  },
  ...
  commands: { label: "Commands", description: "Slash/native command policy" },
  hooks: { label: "Hooks", description: "Webhook ingress and developer lifecycle hooks" },
  ...
  nodeHost: {
    label: "Node Host",
    description: "Advanced companion node host and browser proxy settings",
  },
  ...
  mcp: {
    label: "MCP",
    description: "Owner-managed MCP server definitions for native runtime tools",
  },
  bindings: {
    label: "Bindings",
    description: "Advanced channel-to-Agent route rules",
  },
  broadcast: {
    label: "Broadcast",
    description: "Experimental multi-Agent channel fanout rules",
  },
  session: { label: "Session", description: "Session management and persistence" },
  cron: { label: "Tasks", description: "Scheduled tasks and automation" },
  web: { label: "Web", description: "Web server and API settings" },
  discovery: { label: "Discovery", description: "Service discovery and networking" },
  canvasHost: { label: "Canvas Host", description: "Canvas rendering and display" },
  talk: {
    label: "Talk",
    description: "Voice conversation and TTS defaults for node/mobile Talk mode",
  },
  plugins: { label: "Plugins", description: "Plugin management and extensions" },
  wallet: { label: "Wallet", description: "Advanced wallet provider/runtime plumbing" },
  federation: { label: "Network", description: "Fased Network and marketplace configuration" },
};
...
function matchesSearch(params: {
  ...
  const tagOnlyMatch = criteria.tags.length === 0;

  // Check key name
  if (tagOnlyMatch && q && params.key.toLowerCase().includes(q)) {
    return true;
  }

  // Check label and description
  if (tagOnlyMatch && q && meta) {
              ...
              <section class="config-section-card" id=${id}>
                ...
                <div class="config-section-card__content">
                  ${renderNode({
                    ...
                    showLabel: false,
                    searchCriteria,
                    revealSensitive: props.revealSensitive,
