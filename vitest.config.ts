...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `fased/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: /^\/src\/(.*)$/,
      ...
      {
        find: /^\/test\/(.*)$/,
        replacement: path.join(repoRoot, "test", "$1"),
      },
      {
        find: "fased/plugin-sdk/account-id",
  ...
  test: {
    ...
    include: [
      ...
      "ui/src/ui/dashboard-layout.test.ts",
      "ui/src/ui/federation-api.test.ts",
      "ui/src/ui/mining-commit.test.ts",
      "ui/src/ui/navigation-groups.test.ts",
      "ui/src/ui/navigation.test.ts",
      "ui/src/ui/task-ledger-source-route.node.test.ts",
      "ui/src/ui/wallet-passkey.test.ts",
      "ui/src/ui/views/agents-utils.test.ts",
      "ui/src/ui/views/agents.test.ts",
      "ui/src/ui/views/chat-terminal.test.ts",
      "ui/src/ui/views/config-provider-auth.test.ts",
      ...
      "ui/src/ui/views/notifications.test.ts",
      "ui/src/ui/views/overview.test.ts",
      "ui/src/ui/views/providers.test.ts",
      "ui/src/ui/views/plugins-marketplace.test.ts",
      "ui/src/ui/views/services.test.ts",
      "ui/src/ui/views/usage-render-details.test.ts",
      "ui/src/ui/views/wallet.test.ts",
      "ui/src/ui/controllers/agents.test.ts",
      "ui/src/ui/controllers/channels.test.ts",
      "ui/src/ui/controllers/chat.test.ts",
      "ui/src/ui/controllers/config-auth-action.test.ts",
      "ui/src/ui/controllers/debug.test.ts",
      "ui/src/ui/controllers/dreaming.test.ts",
      "ui/src/ui/controllers/federation.test.ts",
      "ui/src/ui/controllers/memory.test.ts",
      "ui/src/ui/controllers/mining.test.ts",
      "ui/src/ui/controllers/operations-status.test.ts",
      "ui/src/ui/controllers/overview-health.test.ts",
      "ui/src/ui/controllers/sessions.test.ts",
      "ui/src/ui/controllers/wallet.test.ts",
      "ui/src/ui/controllers/plugins-marketplace.test.ts",
    ],
