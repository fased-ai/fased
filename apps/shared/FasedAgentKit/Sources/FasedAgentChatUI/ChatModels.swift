...
public typealias FasedAgentPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FasedAgentPlatformImage = UIImage
#endif

public struct FasedAgentChatUsageCost: Codable, Hashable, Sendable {
...
public struct FasedAgentChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FasedAgentChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FasedAgentChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FasedAgentChatMessageContent: Codable, Hashable, Sendable {
...
public struct FasedAgentChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FasedAgentChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FasedAgentChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FasedAgentChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FasedAgentChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FasedAgentChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FasedAgentChatMessageContent].self, forKey: .content) {
...
public struct FasedAgentChatHistoryPayload: Codable, Sendable {
...
public struct FasedAgentSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FasedAgentSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FasedAgentSessionPreviewItem]
}

public struct FasedAgentSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FasedAgentSessionPreviewEntry]

    public init(ts: Int, previews: [FasedAgentSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FasedAgentChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FasedAgentChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FasedAgentAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FasedAgentChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FasedAgentGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FasedAgentPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FasedAgentPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: FasedAgentPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct FasedAgentChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
