...
public enum FasedAgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct FasedAgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FasedAgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
