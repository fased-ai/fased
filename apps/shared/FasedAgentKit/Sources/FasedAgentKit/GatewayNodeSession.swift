...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.fased", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.fased", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: FasedAgentProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
