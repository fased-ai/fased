...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = FasedAgentChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = FasedAgentChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
