...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = FasedAgentLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = FasedAgentLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.fased.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected FasedAgent agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while FasedAgent is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for FasedAgent. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(FasedAgentLocationMode.off.rawValue)
                            Text("While Using").tag(FasedAgentLocationMode.whileUsing.rawValue)
                            Text("Always").tag(FasedAgentLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while FasedAgent is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("FasedAgent", value: DeviceInfoHelper.fasedVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = FasedAgentLocationMode(rawValue: newValue) else { return }
                Task {
