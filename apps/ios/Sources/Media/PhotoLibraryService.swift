...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FasedAgentPhotosLatestParams) async throws -> FasedAgentPhotosLatestPayload {
        ...
        var results: [FasedAgentPhotoPayload] = []
        ...
        return FasedAgentPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FasedAgentPhotoPayload
    {
