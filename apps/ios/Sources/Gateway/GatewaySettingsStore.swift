...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.fased.gateway"
    private static let nodeService = "ai.fased.node"
    private static let talkService = "ai.fased.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.fased.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.fased.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("fased-gateway.log")
    }
