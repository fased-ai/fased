...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [FasedAgentCapability.canvas.rawValue, FasedAgentCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(FasedAgentCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(FasedAgentCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = FasedAgentLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(FasedAgentCapability.location.rawValue) }

        caps.append(FasedAgentCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(FasedAgentCapability.watch.rawValue)
        }
        caps.append(FasedAgentCapability.photos.rawValue)
        caps.append(FasedAgentCapability.contacts.rawValue)
        caps.append(FasedAgentCapability.calendar.rawValue)
        caps.append(FasedAgentCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(FasedAgentCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            FasedAgentScreenCommand.record.rawValue,
            FasedAgentSystemCommand.notify.rawValue,
            FasedAgentChatCommand.push.rawValue,
        ...
        if caps.contains(FasedAgentCapability.camera.rawValue) {
            commands.append(FasedAgentCameraCommand.list.rawValue)
            commands.append(FasedAgentCameraCommand.snap.rawValue)
            commands.append(FasedAgentCameraCommand.clip.rawValue)
        }
        if caps.contains(FasedAgentCapability.location.rawValue) {
            commands.append(FasedAgentLocationCommand.get.rawValue)
        }
        if caps.contains(FasedAgentCapability.device.rawValue) {
            commands.append(FasedAgentDeviceCommand.status.rawValue)
            commands.append(FasedAgentDeviceCommand.info.rawValue)
        }
        if caps.contains(FasedAgentCapability.watch.rawValue) {
            commands.append(FasedAgentWatchCommand.status.rawValue)
            commands.append(FasedAgentWatchCommand.notify.rawValue)
        }
        if caps.contains(FasedAgentCapability.photos.rawValue) {
            commands.append(FasedAgentPhotosCommand.latest.rawValue)
        }
        if caps.contains(FasedAgentCapability.contacts.rawValue) {
            commands.append(FasedAgentContactsCommand.search.rawValue)
            commands.append(FasedAgentContactsCommand.add.rawValue)
        }
        if caps.contains(FasedAgentCapability.calendar.rawValue) {
            commands.append(FasedAgentCalendarCommand.events.rawValue)
            commands.append(FasedAgentCalendarCommand.add.rawValue)
        }
        if caps.contains(FasedAgentCapability.reminders.rawValue) {
            commands.append(FasedAgentRemindersCommand.list.rawValue)
            commands.append(FasedAgentRemindersCommand.add.rawValue)
        }
        if caps.contains(FasedAgentCapability.motion.rawValue) {
            commands.append(FasedAgentMotionCommand.activity.rawValue)
            commands.append(FasedAgentMotionCommand.pedometer.rawValue)
        }
