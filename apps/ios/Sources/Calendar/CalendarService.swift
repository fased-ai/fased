...
final class CalendarService: CalendarServicing {
    func events(params: FasedAgentCalendarEventsParams) async throws -> FasedAgentCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            FasedAgentCalendarEventPayload(
        ...
        return FasedAgentCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: FasedAgentCalendarAddParams) async throws -> FasedAgentCalendarAddPayload {
        ...
        let payload = FasedAgentCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return FasedAgentCalendarAddPayload(event: payload)
    }
