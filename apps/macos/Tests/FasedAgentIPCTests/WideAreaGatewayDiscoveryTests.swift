...
struct WideAreaGatewayDiscoveryTests {
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
            ...
            dig: { args, _ in
                ...
                if recordType == "PTR" {
                    if nameserver == "@100.123.224.76" {
                        return "steipetacstudio-gateway._fased-gw._tcp.fased.internal.\n"
                    }
                    return ""
                }
                if recordType == "SRV" {
                    return "0 0 18789 steipetacstudio.fased.internal."
                }
                if recordType == "TXT" {
        ...
        #expect(beacon.cliPath == "/Users/steipete/fased/src/entry.ts")
    }
}
