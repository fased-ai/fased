...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: FasedAgentProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": FasedAgentProtocol.AnyCodable("start"),
                "name": FasedAgentProtocol.AnyCodable("bash"),
            ],
            summary: nil)
