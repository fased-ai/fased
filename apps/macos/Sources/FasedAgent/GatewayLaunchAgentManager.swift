...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.fased", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".fased/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.fasedCommand(
            subcommand: "gateway",
