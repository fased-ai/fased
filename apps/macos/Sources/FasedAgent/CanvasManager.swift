...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.fased", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("FasedAgent/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__fased__/a2ui/").absoluteString + "?platform=macos"
    }
