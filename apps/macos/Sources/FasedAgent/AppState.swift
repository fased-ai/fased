...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FasedAgentConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FasedAgentConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = FasedAgentConfigFile.loadDict()
            ...
            FasedAgentConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/fased"
        state.remoteCliPath = ""
        return state
    }
}
