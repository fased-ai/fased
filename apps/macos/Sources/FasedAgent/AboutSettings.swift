...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/fased-ai/agent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/fased-ai/agent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://fased.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "FasedAgentBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FasedAgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FasedAgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FasedAgentGitCommit") as? String) ??
            "unknown"
    }
