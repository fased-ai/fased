...
/// Menu contents for the FasedAgent menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About FasedAgent") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "FasedAgent Not Configured"
        case .remote:
            "Remote FasedAgent Active"
        case .local:
            "FasedAgent Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .fasedSelectSettingsTab, object: tab)
        }
    }
