...
struct FasedAgentApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.fased", category: "app")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.fased", category: "Chat")
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        WalletCustodyCompanionBridge.shared.start()
    ...
    func applicationWillTerminate(_ notification: Notification) {
        ...
        WalletCustodyCompanionBridge.shared.stop()
