...
enum UIStrings {
    static let welcomeTitle = "Welcome to FasedAgent"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "fased.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: FasedAgentChatViewModel
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FasedAgentChatViewModel(
