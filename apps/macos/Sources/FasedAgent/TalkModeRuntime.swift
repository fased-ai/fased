...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.fased", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.fased", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [FasedAgentChatMessage] = messages.compactMap { item in
