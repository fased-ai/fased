...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .fasedSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FasedAgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FasedAgentPaths.stateDirURL.path
...
extension Notification.Name {
    static let fasedSelectSettingsTab = Notification.Name("fasedSelectSettingsTab")
}
