...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.fased", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FasedAgent windows, but below the system’s pop-up menus.
