...
import ai.fased.android.ui.mobileSurface
import ai.fased.android.ui.mobileText
import ai.fased.android.ui.mobileTextSecondary
import ai.fased.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.fased.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.fased.android.ui.mobileFontFamily,
