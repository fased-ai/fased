...
1. Download the runtime for your OS (extracts into `~/.fased/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.fased/tools/sherpa-onnx-tts/models`)

Update `~/.fased/fased.json`:
