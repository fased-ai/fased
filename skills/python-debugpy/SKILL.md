...
metadata: { "fased": { "requires": { "bins": ["python3"] } } }
---

# Python Debugpy

Use when Python code needs local interactive debugging: hidden locals, confusing state mutation, failing tests, subprocesses, long-running services, or remote/headless attach.
