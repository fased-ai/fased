import type { LineChannelData, FasedAgentPluginApi, ReplyPayload } from "fased/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: FasedAgentPluginApi): void {
  api.registerCommand({
    name: "card",
