import type { FasedAgentConfig, PluginRuntime, ResolvedLineAccount } from "fased/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: FasedAgentConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: FasedAgentConfig; accountId: string }): Promise<{
