import type { FasedAgentConfig, PluginRuntime, RuntimeEnv } from "fased/plugin-sdk";
...
async function dispatchMessage(params: { cfg: FasedAgentConfig; event: FeishuMessageEvent }) {
