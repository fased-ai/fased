...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "fased/plugin-sdk";
...
function setFeishuDmPolicy(cfg: FasedAgentConfig, dmPolicy: DmPolicy): FasedAgentConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: FasedAgentConfig, allowFrom: string[]): FasedAgentConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
