...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "fased/plugin-sdk/account-id";
import type {
  FeishuConfig,
  FeishuAccountConfig,
  FeishuDomain,
 ...
 */
function listConfiguredAccountIds(cfg: FasedAgentConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: FasedAgentConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: FasedAgentConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: FasedAgentConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: FasedAgentConfig): ResolvedFeishuAccount[] {
