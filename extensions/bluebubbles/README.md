...
This directory contains the **BlueBubbles external channel plugin** for FasedAgent.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `fased/plugin-sdk` helpers.
