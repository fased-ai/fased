...
import { resolveChannelMediaMaxBytes, type FasedAgentConfig } from "fased/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: FasedAgentConfig; accountId?: string }): string[] {
