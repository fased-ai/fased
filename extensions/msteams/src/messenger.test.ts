...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "fased/plugin-sdk";
...
import { resolvePreferredFasedAgentTmpDir } from "../../../src/infra/tmp-fased-dir.js";
import {
  type MSTeamsAdapter,
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(
        path.join(resolvePreferredFasedAgentTmpDir(), "msteams-mention-"),
      );
