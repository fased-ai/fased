...
export const SAT_VNEXT_ACTIVATION = {
  ...
  programs: {
    mining: {
      ...
      deploymentSlot: 490182796,
      allocatedImageSha256:
        "sha256:8098f9a708fd85cfc571cbba225c4019598243e1f079686feb1f419ba409596d", // pragma: allowlist secret
    },
    mint: {
  ...
  protocolGenerationState: {
    ...
    accountSha256: "sha256:09523702faa9445f87be30bad31af6ba09570a0a39829c1ec466322cbba0df5a", // pragma: allowlist secret
    publicEntryEnabled: true,
    activationGeneration: 10,
  ...
  activation: {
    signature:
      "25tD5oBsJjZmDnShYgkuijk2cKhnbhwptRkwvYMre4qiUEw5qALiiRh6QXM2jgeUNRY6A7kSWj59nibT5Q1oChTf", // pragma: allowlist secret
    finalizedSlot: 490184880,
    receiptDigest: "sha256:8aaadde73d83ffc325a308e3ab2037d07480e9ac649a76a9f196c2d986f2d453", // pragma: allowlist secret
  },
  replacementDeployment: {
    signature:
      "51dMbKNPXznHUkSxEzaV64Ti8Jh1gbyyVb5isGXZUFnbvw2UJ8qP5kyM5h3BX14LK8kGYmjvdxS7VWjxbQKc9GGN", // pragma: allowlist secret
    finalizedSlot: 490182796,
    descriptorSha256: "sha256:33f90bea210eabd41358946467e16ae3c02f576efd8a65830e84664554647502", // pragma: allowlist secret
    artifactSha256: "sha256:8b471578d9eeb99ee92a3d3ccf74f3368a76dc97e99efd953157f07ceafd6813", // pragma: allowlist secret
    artifactBytes: 759888,
    allocatedImageSha256: "sha256:8098f9a708fd85cfc571cbba225c4019598243e1f079686feb1f419ba409596d", // pragma: allowlist secret
    allocatedImageBytes: 764176,
    zeroPaddingBytes: 4288,
  },
} as const;
