...
Official Voice Call plugin for **FasedAgent**.
...
Docs: `https://docs.fased.ai/plugins/voice-call`
Plugin system: `https://docs.fased.ai/plugin`

## Install (local dev)

### Option A: install via FasedAgent (recommended)
...
```bash
mkdir -p ~/.fased/extensions
cp -R extensions/voice-call ~/.fased/extensions/voice-call
cd ~/.fased/extensions/voice-call && pnpm install
```
...
```bash
fased voicecall call --to "+15555550123" --message "Hello from FasedAgent"
