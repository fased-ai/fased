...
const qwenPortalPlugin = {
  id: "qwen-portal-auth",
  name: "Qwen OAuth",
  description: "Legacy Qwen portal OAuth flow",
          ...
          run: async (ctx: ProviderAuthContext) => {
            ...
            try {
              ...
              return {
                ...
                notes: [
                  "Qwen OAuth tokens auto-refresh while Qwen portal access remains available. Re-run login if refresh fails or access is revoked.",
