...
import { fetchWithSsrFGuard, isWSL2Sync } from "fased/plugin-sdk";

const CLIENT_ID_KEYS = ["FASED_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = ["FASED_GEMINI_OAUTH_CLIENT_SECRET", "GEMINI_CLI_OAUTH_CLIENT_SECRET"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to FasedAgent.</p></body></html>",
        );
