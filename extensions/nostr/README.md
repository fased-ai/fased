...
Nostr DM channel plugin for FasedAgent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FasedAgent. It enables your bot to:
...
# Configure fased to use local relay
