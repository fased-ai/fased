...
export function listGoogleChatAccountIds(cfg: FasedAgentConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: FasedAgentConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: FasedAgentConfig): ResolvedGoogleChatAccount[] {
