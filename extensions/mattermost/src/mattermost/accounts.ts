...
export function listMattermostAccountIds(cfg: FasedAgentConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: FasedAgentConfig): string {
...
export function listEnabledMattermostAccounts(cfg: FasedAgentConfig): ResolvedMattermostAccount[] {
