...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "fased", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for FasedAgent. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("FasedAgent Issue Label Audit");
