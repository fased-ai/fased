...
if [[ -z "$version_content" ]]; then
  echo "<h2>FasedAgent $VERSION</h2>"
  echo "<p>Latest FasedAgent update.</p>"
  echo "<p><a href=\"https://github.com/fased-ai/fased/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
