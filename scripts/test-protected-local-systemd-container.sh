...
MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC="${FASED_SYSTEMD_FIXTURE_MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC:-0}"
...
[[ "$MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC" == "0" ||
  "$MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC" == "1" ]] || {
  echo "FASED_SYSTEMD_FIXTURE_MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC must be 0 or 1." >&2
  exit 1
}
...
run_fixture_scenario() {
  ...
  run_container run -d \
    ...
    -e "FASED_FIXTURE_PREDECESSOR_BOOTSTRAP_RUN_EXEC=$MANAGED_PREDECESSOR_BOOTSTRAP_RUN_EXEC" \
