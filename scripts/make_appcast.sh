...
FEED_URL=${2:-"https://raw.githubusercontent.com/fased-ai/agent/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/fased-ai/agent/releases/download/v${VERSION}/"}
