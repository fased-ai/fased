...
- Keep product names in English: FasedAgent, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FasedAgent Gateway, use “Gateway 网关”.
