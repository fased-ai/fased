...
node -e '
  ...
  const expected = ["bin/fased-gateway-launch", "bin/fased-lifecycled", "bin/fased-signerd", "runtime/fased.mjs", "runtime/node_modules/.bin/tool", "runtime/node_modules/tool/bin/cli.js"];
