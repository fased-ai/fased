...
# Output:
# - dist/FasedAgent.app
# - dist/FasedAgent-<version>.zip
# - dist/FasedAgent-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.fased.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/FasedAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FasedAgent-$VERSION.zip"
DMG="$ROOT_DIR/dist/FasedAgent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FasedAgent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FasedAgent-$VERSION.dSYM.zip"
