...
export DISPLAY=:1
export HOME=/tmp/fased-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${FASED_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${FASED_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${FASED_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${FASED_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${FASED_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${FASED_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${FASED_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${FASED_BROWSER_NOVNC_PASSWORD:-}"
