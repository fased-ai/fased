...
const mocks = vi.hoisted(() => ({
  loadConfig: vi.fn<() => FasedAgentConfig>(),
...
describe("ensureBrowserControlAuth", () => {
  const expectExplicitModeSkipsAutoAuth = async (mode: "password" | "trusted-proxy") => {
  ...
  it("respects explicit none mode", async () => {
    await expectExplicitModeSkipsAutoAuth("trusted-proxy");
  });
