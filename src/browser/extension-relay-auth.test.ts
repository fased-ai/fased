...
import {
  probeAuthenticatedFasedAgentRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated fased relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedFasedAgentRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-fased-relay-token",
