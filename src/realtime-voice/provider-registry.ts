...
function buildProviderMaps(_cfg?: FasedAgentConfig): {
  ...
  for (const provider of resolveRealtimeVoiceProviderEntries(_cfg)) {
    register(provider);
  }
...
export function listRealtimeVoiceProviders(cfg?: FasedAgentConfig): RealtimeVoiceProviderPlugin[] {
