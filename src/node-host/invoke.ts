...
const execHostEnforced = process.env.FASED_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.FASED_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
