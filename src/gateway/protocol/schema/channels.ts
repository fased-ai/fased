...
export const ChannelsStatusResultSchema = Type.Object(
  {
    ...
    channelSetup: Type.Optional(Type.Record(NonEmptyString, Type.Unknown())),
...
export const ChannelsRuntimeControlParamsSchema = Type.Object(
  {
    channel: NonEmptyString,
    accountId: Type.Optional(Type.String()),
  },
...
export const ChannelsRuntimeControlResultSchema = Type.Object(
  {
    channel: NonEmptyString,
