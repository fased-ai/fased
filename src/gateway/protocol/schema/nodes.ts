...
export const NodePendingWorkTypeSchema = Type.Union([
  Type.Literal("status.request"),
  Type.Literal("location.request"),
]);

export const NodePendingWorkPrioritySchema = Type.Union([
  Type.Literal("normal"),
  Type.Literal("high"),
]);
...
export const NodePendingPullParamsSchema = NodePendingDrainParamsSchema;

export const NodePendingAckParamsSchema = Type.Object(
  {
    ids: Type.Array(NonEmptyString, { minItems: 1, maxItems: 100 }),
  },
  { additionalProperties: false },
);
