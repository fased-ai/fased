...
function contentTypeForExt(ext: string): string {
  return CONTENT_TYPES_BY_EXT[ext] ?? "application/octet-stream";
}
...
function setStaticFileHeaders(res: ServerResponse, filePath: string) {
  ...
  // The dashboard is a private runtime surface served directly by the gateway.
  // Avoid browser/Tailscale cached app shells or chunks after an update; stale
  // chunks otherwise look like an offline gateway from the user's browser.
