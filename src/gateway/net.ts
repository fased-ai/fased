...
export { resolveForwardedClientIp as parseForwardedForClientIp };
...
export { resolveClientIp as resolveGatewayClientIp };
...
export function isLocalishHost(hostHeader?: string): boolean {
  ...
  return isLoopbackHost(host) || host.endsWith(".ts.net") || isLocalGatewayAddress(host);
}
