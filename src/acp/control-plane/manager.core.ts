...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: FasedAgentConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: FasedAgentConfig): AcpManagerObservabilitySnapshot {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: FasedAgentConfig }): Promise<void> {
