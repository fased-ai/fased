...
export function isAcpEnabledByPolicy(cfg: FasedAgentConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: FasedAgentConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: FasedAgentConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: FasedAgentConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: FasedAgentConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: FasedAgentConfig, agentId: string): boolean {
