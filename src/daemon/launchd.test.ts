...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.fased.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", FASED_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.fased.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when FASED_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.fased.gateway.plist",
    },
    {
      name: "uses profile-specific label when FASED_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", FASED_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.fased.jbphoenix.plist",
    },
    {
      name: "prefers FASED_LAUNCHD_LABEL over FASED_PROFILE",
      env: {
        HOME: "/Users/test",
        FASED_PROFILE: "jbphoenix",
        FASED_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from FASED_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        FASED_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty FASED_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        FASED_PROFILE: "myprofile",
        FASED_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.fased.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
