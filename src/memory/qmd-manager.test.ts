...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: FasedAgentConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: FasedAgentConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__fasedMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__fasedMcporterColdStartWarned;
  });
