...
function resolveWatchPaths(workspaceDir: string, config?: FasedAgentConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: FasedAgentConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FasedAgentConfig }) {
