import type { FasedAgentConfig, SkillConfig } from "../../config/config.js";
import {
  clearHasBinaryCache,
...
export function isConfigPathTruthy(config: FasedAgentConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["fased-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: FasedAgentConfig): string[] | undefined {
