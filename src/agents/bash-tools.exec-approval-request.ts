import type { ExecAsk, ExecSecurity, SystemRunApprovalPlanV2 } from "../infra/exec-approvals.js";
import {
...
export type RequestExecApprovalDecisionParams = {
  ...
  command?: string;
  commandArgv?: string[];
  systemRunPlan?: SystemRunApprovalPlanV2;
...
type ExecApprovalRequestToolParams = Omit<RequestExecApprovalDecisionParams, "systemRunPlan"> & {
  systemRunPlanV2?: SystemRunApprovalPlanV2;
  timeoutMs: number;
  twoPhase: true;
};
...
function buildExecApprovalRequestToolParams(
  ...
  return {
    ...
    systemRunPlanV2: params.systemRunPlan,
    env: params.env,
    cwd: params.cwd,
