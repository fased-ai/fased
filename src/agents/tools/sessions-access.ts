...
export function resolveSessionToolsVisibility(cfg: FasedAgentConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: FasedAgentConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: FasedAgentConfig): AgentToAgentPolicy {
