...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): FasedAgentConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: FasedAgentConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: FasedAgentConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
