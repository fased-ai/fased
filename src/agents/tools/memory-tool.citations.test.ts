...
function asFasedAgentConfig(config: Partial<FasedAgentConfig>): FasedAgentConfig {
  return config;
}

function createToolConfig() {
  return asFasedAgentConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: FasedAgentConfig = createToolConfig()) {
