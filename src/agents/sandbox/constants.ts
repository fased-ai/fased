...
export const DEFAULT_SANDBOX_IMAGE = "fased-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "fased-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "fased-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "fased-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "fased-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "fased-sandbox-browser";
