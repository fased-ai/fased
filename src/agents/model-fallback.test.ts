...
function makeProviderFallbackCfg(provider: string): FasedAgentConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
...
// https://github.com/fased/fased/issues/23440
const INSUFFICIENT_QUOTA_PAYLOAD =
  '{"type":"error","error":{"type":"insufficient_quota","message":"Your account has insufficient quota balance to run this request."}}';
// Internal FasedAgent compatibility marker, not a provider API contract.
