...
export const CHUTES_DEFAULT_MODEL_ID = "google/gemma-4-31B-turbo-TEE";
...
export const CHUTES_MODEL_CATALOG: ModelDefinitionConfig[] = [
  {
    ...
    name: "google/gemma-4-31B-turbo-TEE",
    reasoning: false,
    input: ["text"],
    contextWindow: 128000,
    maxTokens: 65536,
    cost: { input: 0.0245, output: 0.0978, cacheRead: 0, cacheWrite: 0 },
  },
  {
