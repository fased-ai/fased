...
const MISTRAL_MODELS: ModelDefinitionConfig[] = [
  ...
  model({
    ...
    capabilities: { tools: true, json: true, fixedReasoning: true },
  }),
  model({
...
const QWEN_MODELS: ModelDefinitionConfig[] = [
  ...
  model({ id: "glm-5", name: "glm-5", contextWindow: 202_752, maxTokens: 16_384 }),
  model({ id: "glm-4.7", name: "glm-4.7", contextWindow: 202_752, maxTokens: 16_384 }),
  model({
    id: "kimi-k2.5",
    name: "kimi-k2.5",
    input: ["text", "image"],
