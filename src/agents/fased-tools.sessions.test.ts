...
import "./test-helpers/fast-fased-tools-sessions.js";
...
function createFasedCompatTools(options?: {
...
describe("sessions tools", () => {
  ...
  it("sessions_list filters kinds and includes messages", async () => {
    ...
    const tool = createFasedCompatTools().find((candidate) => candidate.name === "sessions_list");
    expect(tool).toBeDefined();
    if (!tool) {
  ...
  it("sessions_history filters tool messages by default", async () => {
    ...
    const tool = createFasedCompatTools().find(
  ...
  it("sessions_send supports fire-and-forget and wait", async () => {
    ...
    const tool = createFasedCompatTools({
