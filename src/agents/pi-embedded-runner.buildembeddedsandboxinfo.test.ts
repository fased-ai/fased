...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/fased-sandbox",
    agentWorkspaceDir: "/tmp/fased-workspace",
    workspaceAccess: "none",
    runtimeId: "fased-sbx-test",
    runtimeLabel: "fased-sbx-test",
    ...
    browser: {
      ...
      containerName: "fased-sbx-browser-test",
    },
