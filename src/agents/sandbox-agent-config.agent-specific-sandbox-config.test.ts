...
async function resolveContext(config: FasedAgentConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): FasedAgentConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
