...
type FasedAgentReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: FasedAgentReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFasedAgentReadTool(base, {
...
export function createFasedAgentReadTool(
  base: AnyAgentTool,
  options?: FasedAgentReadToolOptions,
): AnyAgentTool {
