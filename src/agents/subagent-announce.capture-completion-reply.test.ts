...
describe("captureSubagentCompletionReply", () => {
  ...
  let captureSubagentCompletionReply: (typeof import("./subagent-announce-output.js"))["captureSubagentCompletionReply"];

  async function loadFreshSubagentAnnounceModuleForTest() {
    vi.resetModules();
    ({ captureSubagentCompletionReply } = await import("./subagent-announce-output.js"));
  }
