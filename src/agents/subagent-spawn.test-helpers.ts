...
export async function loadSubagentSpawnModuleForTest(params: {
  callGatewayMock: AnyFn;
  loadConfig?: () => Record<string, unknown>;
  updateSessionStoreMock?: AnyFn;
  pruneLegacyStoreKeysMock?: AnyFn;
  registerSubagentRunMock?: AnyFn;
  emitSessionLifecycleEventMock?: AnyFn;
...
}): Promise<typeof import("./subagent-spawn.js") & { resetSubagentRegistryForTests: MockFn }> {
