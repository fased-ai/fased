/* oxlint-disable typescript/no-redundant-type-constituents -- async task registry types are part of the existing strict-type backlog. */
...
export function isActiveMediaGenerationTask(params: {
  ...
  return (
    (params.task.runtime === "media" || params.task.runtime === "cli") &&
