...
const PROBE_STATE_TTL_MS = 10 * 60 * 1000;
...
function pruneProbeThrottleState(now: number): void {
  for (const [key, timestamp] of lastProbeAttempt) {
    if (now - timestamp > PROBE_STATE_TTL_MS) {
