...
function buildNoVideoGenerationModelConfiguredMessage(cfg: FasedAgentConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: FasedAgentConfig }) {
