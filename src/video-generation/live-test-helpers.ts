...
export function resolveLiveVideoResolution(_params: {
  providerId: string;
  modelRef: string;
}): "480P" | "768P" | "1080P" {
  const providerId = _params.providerId.trim().toLowerCase();
...
export function resolveConfiguredLiveVideoModels(cfg: FasedAgentConfig): Map<string, string> {
