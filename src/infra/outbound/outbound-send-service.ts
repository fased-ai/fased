...
async function tryHandleWithPluginAction(params: {
  ...
  const handled = await dispatchChannelMessageAction({
    ...
    requesterAccountId: params.ctx.requesterAccountId ?? undefined,
    requesterSenderId: params.ctx.requesterSenderId ?? undefined,
    requesterSenderName: params.ctx.requesterSenderName ?? undefined,
    requesterSenderUsername: params.ctx.requesterSenderUsername ?? undefined,
    requesterSenderE164: params.ctx.requesterSenderE164 ?? undefined,
