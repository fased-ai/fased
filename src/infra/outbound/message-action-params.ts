...
function parseJsonMessageParam(params: Record<string, unknown>, key: string): void {
  const raw = params[key];
  if (typeof raw !== "string") {
    return;
  }
...
export function parseButtonsParam(params: Record<string, unknown>): void {
  parseJsonMessageParam(params, "buttons");
}

export function parseCardParam(params: Record<string, unknown>): void {
  parseJsonMessageParam(params, "card");
}

export function parseComponentsParam(params: Record<string, unknown>): void {
  parseJsonMessageParam(params, "components");
}

export function parsePresentationParam(params: Record<string, unknown>): void {
  parseJsonMessageParam(params, "presentation");
}

export function parseDeliveryParam(params: Record<string, unknown>): void {
