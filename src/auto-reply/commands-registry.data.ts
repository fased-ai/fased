...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "agent",
      nativeName: "agent",
      description: "List or switch the Agent for this channel chat.",
      textAlias: "/agent",
      category: "session",
      args: [
        {
          name: "action",
          description: "list | current | switch",
          type: "string",
          choices: ["list", "current", "switch"],
        },
        {
          name: "agent",
    ...
    defineChatCommand({
      key: "session",
      nativeName: "session",
      description: "Create, list, switch, or tune sessions for this chat.",
      textAlias: "/session",
      category: "session",
      args: [
        {
          name: "action",
          description: "list | new | switch | current | idle | max-age",
          type: "string",
          choices: ["list", "new", "switch", "current", "main", "close", "idle", "max-age"],
        },
        {
          name: "value",
          description: "Session name, key, duration (24h, 90m), or off",
          type: "string",
          captureRemaining: true,
        },
      ],
    ...
    defineChatCommand({
      key: "task",
      nativeName: "task",
      description: "Create, list, edit, run, or cancel scheduled tasks for this Agent/session.",
      textAlias: "/task",
      category: "management",
      args: [
        {
          name: "action",
          description: "new | list | edit | run | cancel",
          type: "string",
          choices: ["new", "list", "edit", "run", "cancel"],
        },
        {
          name: "value",
          description:
            "Schedule spec, all for Agent-wide list, or task id plus edit/run/cancel args",
          type: "string",
          captureRemaining: true,
        },
      ],
    ...
    defineChatCommand({
      key: "restart",
      nativeName: "restart",
      description: "Restart FasedAgent.",
      textAlias: "/restart",
      category: "tools",
    }),
    defineChatCommand({
