...
describe("resolveResponsePrefixTemplate", () => {
  ...
  it("handles complex template with all variables", () => {
    ...
    expect(result).toBe("[FasedAgent] anthropic/claude-opus-4-5 (think:high)");
  });
});
...
describe("extractShortModelName", () => {
  it("strips provider prefix", () => {
    ...
    expect(extractShortModelName("openai-codex/gpt-5.3-codex")).toBe("gpt-5.3-codex");
  });
