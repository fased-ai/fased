...
function resolveMentionPatterns(cfg: FasedAgentConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FasedAgentConfig | undefined, agentId?: string): RegExp[] {
