...
export const __testing = {
  setDepsForTests(_overrides?: { resolveEmbeddedSessionLane?: (key: string) => string }) {
    // Compatibility hook for older tests. The current implementation keeps queue cleanup dependencies static.
  },
};
