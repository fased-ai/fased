...
export const ModelCapabilitySchema = z
  .object({
    ...
    fixedReasoning: z.boolean().optional(),
    thinkingLevels: z
      .array(
        z.union([
          z.literal("off"),
    ...
    thinkingMode: z
      .union([
        ...
        z.literal("anthropic-thinking-budget"),
        z.literal("anthropic-adaptive"),
        z.literal("google-thinking-budget"),
        z.literal("xai-reasoning-effort"),
        z.literal("xai-multi-agent-effort"),
        z.literal("mistral-reasoning-effort"),
        z.literal("volcengine-reasoning-effort"),
        z.literal("byteplus-thinking-type"),
        z.literal("zai-binary"),
        z.literal("qwen-thinking"),
        z.literal("moonshot-thinking"),
        z.literal("generic-reasoning"),
      ])
      .optional(),
    reasoningBudgetSupported: z.boolean().optional(),
  })
  .strict()
  .optional();
