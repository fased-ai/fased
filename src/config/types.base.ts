...
export type SessionConfig = {
   ...
   * If parent totalTokens is above this value, FasedAgent skips parent fork and
...
export type DiagnosticsPrometheusConfig = {
  enabled?: boolean;
  /** HTTP path for Prometheus text exposition. Default: /metrics. */
  path?: string;
  /**
   * Require normal gateway probe auth for remote clients. Local loopback requests remain allowed.
   * Default: true.
   */
  requireAuth?: boolean;
  /** Include lightweight runtime/process gauges. Default: true. */
