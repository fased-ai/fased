...
import {
  AgentModelProviderSchema,
  AgentModelSchema,
  AgentTaskModelSlotsSchema,
  ...
  .object({
    ...
    duckduckgo: z
      .object({
        ...
        safeSearch: z
          .union([z.literal("strict"), z.literal("moderate"), z.literal("off")])
          .optional(),
      })
      .strict()
      .optional(),
...
export const MemorySearchSchema = z
  ...
  .strict()
  .optional();
export { AgentModelProviderSchema, AgentModelSchema, AgentTaskModelSlotsSchema };
export const AgentEntrySchema = z
  .object({
    ...
    modelProviders: z.record(z.string(), AgentModelProviderSchema).optional(),
    ...
    strictAgentic: z
      .object({
        mode: z.union([z.literal("off"), z.literal("warn")]).optional(),
      })
      .strict()
      .optional(),
  })
