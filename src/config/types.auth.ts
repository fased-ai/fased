...
export type AuthConfig = {
  ...
  cooldowns?: {
    ...
    /** Legacy-compatible overload cooldown override (ms). New code uses standard profile cooldown windows. */
    overloadedBackoffMs?: number;
    /** Legacy-compatible cap for overload profile rotations. */
    overloadedProfileRotations?: number;
    /** Legacy-compatible cap for rate-limit profile rotations. */
