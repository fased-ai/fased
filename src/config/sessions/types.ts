...
export type SessionEntry = {
  ...
  spawnedBy?: string;
  /** Legacy alias retained for older tests and persisted stores. Prefer spawnedBy/baseSessionKey. */
  ...
  /** Runtime status snapshot for detached/sub-agent sessions. */
  status?: string;
  /** Runtime start timestamp for detached/sub-agent sessions. */
  startedAt?: number;
  /** Runtime end timestamp for detached/sub-agent sessions. */
  endedAt?: number;
  /** Runtime duration snapshot for detached/sub-agent sessions. */
  runtimeMs?: number;
  /**
  ...
  /** Base channel/session key that owns this named child session. */
  baseSessionKey?: string;
  /** Stable slug used by /session switch/list for named channel sessions. */
  sessionSlug?: string;
  channel?: string;
  groupId?: string;
  subject?: string;
