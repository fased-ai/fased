...
export type HookMappingConfig = {
  id?: string;
  /** Disabled mappings stay configured but are ignored by webhook runtime. */
  enabled?: boolean;
  ...
  textTemplate?: string;
  /** Saved Agent workflow/graph definition to run when action is "workflow". */
  ...
  /** Task ledger notification policy for webhook-triggered Agent runs. */
...
export type HooksConfig = {
   ...
   * If omitted, FasedAgent generates `hook:<uuid>` per request.
   */
