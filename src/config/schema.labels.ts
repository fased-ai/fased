...
const FIELD_LABELS_BASE: Record<string, string> = {
  ...
  acp: "ACP Runtime",
  "acp.enabled": "Enable ACP Runtime",
  "acp.dispatch.enabled": "Enable ACP Dispatch",
  ...
  "diagnostics.prometheus.enabled": "Prometheus Metrics Enabled",
  "diagnostics.prometheus.path": "Prometheus Metrics Path",
  "diagnostics.prometheus.requireAuth": "Prometheus Metrics Require Auth",
  "diagnostics.prometheus.includeRuntime": "Prometheus Metrics Include Runtime",
  ...
  "agents.list.*.activeModelProvider": "Legacy Active Model Provider",
  "agents.list.*.modelProviders": "Legacy Agent Model Providers",
  "agents.list.*.modelProviders.*.profileId": "Legacy Agent Provider Profile",
  "agents.list.*.modelProviders.*.primary": "Legacy Agent Provider Primary Model",
  "agents.list.*.modelProviders.*.fallbacks": "Legacy Agent Provider Fallback Models",
  "agents.list.*.modelProviders.*.taskModels.cheapCheck": "Legacy Agent Provider Cheap Check Model",
  "agents.list.*.modelProviders.*.taskModels.strong": "Legacy Agent Provider Strong Model",
  "agents.list.*.modelProviders.*.taskModels.escalation": "Legacy Agent Provider Escalation Model",
  "agents.list.*.modelProviders.*.taskModels.coding": "Legacy Agent Provider Coding Model",
  "agents.list.*.modelProviders.*.taskModels.summarizer": "Legacy Agent Provider Summarizer Model",
  "agents.list.*.taskModels.cheapCheck": "Agent Task Cheap Check Model",
  "agents.list.*.taskModels.strong": "Agent Task Strong Model",
  "agents.list.*.taskModels.escalation": "Agent Task Escalation Model",
  "agents.list.*.taskModels.coding": "Agent Task Coding Model",
  "agents.list.*.taskModels.summarizer": "Agent Task Summarizer Model",
  "agents.list[].activeModelProvider": "Legacy Active Model Provider",
  "agents.list[].modelProviders": "Legacy Agent Model Providers",
  "agents.list[].modelProviders.*.profileId": "Legacy Agent Provider Profile",
  "agents.list[].modelProviders.*.primary": "Legacy Agent Provider Primary Model",
  ...
  "agents.list[].taskModels.coding": "Agent Task Coding Model",
  "agents.list[].taskModels.summarizer": "Agent Task Summarizer Model",
  "agents.defaults.strictAgentic.mode": "Strict-Agentic Policy",
  "agents.list.*.strictAgentic.mode": "Agent Strict-Agentic Policy",
  "agents.list[].strictAgentic.mode": "Agent Strict-Agentic Policy",
  ...
  "channels.discord.threadBindings.enabled": "Discord Thread Bindings",
  "channels.discord.threadBindings.idleHours": "Discord Thread Idle Timeout (hours)",
  "channels.discord.threadBindings.maxAgeHours": "Discord Thread Max Age (hours)",
  "channels.discord.threadBindings.spawnSubagentSessions": "Discord Thread Subagent Spawns",
  "channels.discord.threadBindings.spawnAcpSessions": "Discord Thread ACP Spawns",
  ...
  "gateway.trustedProxies": "Gateway Trusted Proxies",
  "gateway.allowRealIpFallback": "Allow Real-IP Fallback",
  ...
  "skills.marketplace.allowRegistries": "Skill Marketplace Wallet Registries",
  ...
  wallet: "Wallet",
  "wallet.provider.id": "Wallet Provider",
  "wallet.execution.mode": "Wallet Execution Mode",
  "wallet.approvalAuth.mode": "Wallet Approval Auth Mode",
  "wallet.approvalAuth.challengeTtlSeconds": "Wallet Approval Challenge TTL (sec)",
  "wallet.approvalAuth.grantTtlSeconds": "Wallet Approval Grant TTL (sec)",
  "wallet.keystore.enabled": "Legacy Keystore (Retired)",
  "wallet.keystore.path": "Legacy Keystore Migration Path",
  "wallet.keystore.chainSupport": "Legacy Keystore Chains",
  "wallet.keystore.autoLockSeconds": "Legacy Keystore Auto Lock (Retired)",
  "wallet.runtime.enabled": "Wallet Runtime Enabled",
  "wallet.runtime.mode": "Wallet Runtime Mode",
  "wallet.runtime.runtime": "Wallet Runtime Kind",
  "wallet.runtime.external.kind": "Wallet External Kind",
  "wallet.runtime.auth.mode": "Wallet Runtime Auth Mode",
  "wallet.runtime.auth.bootstrapUrl": "Wallet Runtime Auth Bootstrap URL",
  "wallet.runtime.source.ref": "Wallet Source Ref",
  "wallet.runtime.chains": "Wallet Chains",
  "wallet.runtime.service.host": "Wallet Service Host",
  "wallet.runtime.service.port": "Wallet Service Port",
  "wallet.runtime.install.enabled": "Wallet Runtime Install Enabled",
  "wallet.runtime.install.version": "Wallet Runtime Install Version",
  "wallet.runtime.policy.directSigning": "Wallet Automated Execution",
  "wallet.runtime.policy.capsEnabled": "Wallet Caps Enabled",
  "wallet.runtime.policy.solana.allowPrograms": "Wallet Solana Allow Programs",
  "wallet.runtime.policy.solana.tokenCaps": "Wallet Solana Token Caps",
  "wallet.runtime.policy.solana.maxPerTx": "Wallet Solana Max Per Tx",
  "wallet.runtime.policy.solana.maxDaily": "Wallet Solana Max Daily",
  "wallet.runtime.toolAccess.mode": "Wallet Tool Access Mode",
  "wallet.runtime.toolAccess.allowAgents": "Wallet Tool Access Agents",
  "wallet.runtime.toolAccess.allowSkills": "Wallet Tool Access Skills",
  "wallet.runtime.toolAccess.denySkills": "Wallet Tool Access Deny Skills",
  "wallet.runtime.toolAccess.allowSources": "Wallet Tool Access Sources",
  ...
  "agents.defaults.taskModels.cheapCheck": "Task Cheap Check Model",
  "agents.defaults.taskModels.strong": "Task Strong Model",
  "agents.defaults.taskModels.escalation": "Task Escalation Model",
  "agents.defaults.taskModels.coding": "Task Coding Model",
  "agents.defaults.taskModels.summarizer": "Task Summarizer Model",
  ...
  "channels.msteams.preserveFilenames": "MS Teams Preserve Filenames",
  ...IRC_FIELD_LABELS,
  ...
  "plugins.entries.*.runtime.helpers.sessions.read": "Plugin Session Read Helper",
  "plugins.entries.*.runtime.adminRpcActions": "Plugin Admin RPC Grants",
  "plugins.entries.*.runtime.adminRpcActions.allow": "Plugin Admin RPC Allowlist",
  "plugins.entries.*.runtime.adminRpcActions.allow[].method": "Plugin Admin RPC Method",
  "plugins.entries.*.runtime.adminRpcActions.allow[].sources": "Plugin Admin RPC Sources",
  "plugins.entries.*.runtime.adminRpcActions.allow[].requireOperatorApproval":
    "Plugin Admin RPC Operator Approval",
...
function humanizeConfigKey(key: string): string {
  const fallback = key.split(".").filter(Boolean).at(-1) ?? key;
  return fallback
    .replace(/\[\]/g, "")
    .replace(/\*/g, "Wildcard")
...
export const FIELD_LABELS: Record<string, string> = new Proxy(FIELD_LABELS_BASE, {
  get(target, prop, receiver) {
    if (typeof prop !== "string") {
      return Reflect.get(target, prop, receiver);
    }
    return Reflect.get(target, prop, receiver) ?? humanizeConfigKey(prop);
  },
  has(target, prop) {
