...
export function listBindings(cfg: FasedAgentConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: FasedAgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FasedAgentConfig) {
