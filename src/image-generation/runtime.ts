...
function buildNoImageGenerationModelConfiguredMessage(cfg: FasedAgentConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: FasedAgentConfig }) {
