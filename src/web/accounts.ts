...
import { hasWebCredsSync } from "./auth-state.js";
...
export function listWhatsAppAuthDirs(cfg: FasedAgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FasedAgentConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FasedAgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FasedAgentConfig): ResolvedWhatsAppAccount[] {
