...
export async function sendMessageWhatsApp(
  ...
  try {
    ...
    logger.error(
      { err: formatError(err), to: redactedTo, hasMedia: Boolean(options.mediaUrl) },
...
export async function sendReactionWhatsApp(
  ...
  try {
    ...
    logger.error(
      { err: formatError(err), chatJid: redactedChatJid, messageId, emoji },
...
export async function sendPollWhatsApp(
  ...
  try {
    ...
    logger.error({ err: formatError(err), to: redactedTo }, "failed to send poll via web session");
    throw err;
  }
}
