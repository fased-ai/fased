...
function resolveResolutionLimits(config: FasedAgentConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FasedAgentConfig): SecretProviderConfig {
