...
function makeCfg(overrides?: Partial<FasedAgentConfig>): FasedAgentConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
describe("resolveWhatsAppHeartbeatRecipients", () => {
  ...
  function resolveWith(
    cfgOverrides: Partial<FasedAgentConfig> = {},
  ...
  it("ignores session store when session scope is global", () => {
    ...
    const result = resolveWith({
      session: { scope: "global" } as FasedAgentConfig["session"],
