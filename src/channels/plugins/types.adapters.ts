...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: FasedAgentConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: FasedAgentConfig) => string;
  setAccountEnabled?: (params: {
    cfg: FasedAgentConfig;
    accountId: string;
    enabled: boolean;
  }) => FasedAgentConfig;
  deleteAccount?: (params: { cfg: FasedAgentConfig; accountId: string }) => FasedAgentConfig;
  isEnabled?: (account: ResolvedAccount, cfg: FasedAgentConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: FasedAgentConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: FasedAgentConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: FasedAgentConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: FasedAgentConfig) => ChannelAccountSnapshot;
