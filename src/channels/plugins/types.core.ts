...
export type ChannelAgentToolFactory = (params: { cfg?: FasedAgentConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FasedAgentConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: FasedAgentConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FasedAgentConfig }) => boolean;
  supportsCards?: (params: { cfg: FasedAgentConfig }) => boolean;
