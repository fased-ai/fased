...
export function listChannelMessageActions(cfg: FasedAgentConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FasedAgentConfig): boolean {
...
export function supportsChannelMessageCards(cfg: FasedAgentConfig): boolean {
