...
import type * as TelegramAccounts from "./accounts.js";
...
let listTelegramAccountIds: typeof TelegramAccounts.listTelegramAccountIds;
let resolveTelegramAccount: typeof TelegramAccounts.resolveTelegramAccount;
...
describe("resolveTelegramAccount", () => {
  ...
  it("formats debug logs with inspect-style output when debug env is enabled", () => {
    withEnv({ TELEGRAM_BOT_TOKEN: "", FASED_DEBUG_TELEGRAM_ACCOUNTS: "1" }, () => {
      const cfg: FasedAgentConfig = {
        channels: {
          telegram: { accounts: { work: { botToken: "tok-work" } } },
        },
