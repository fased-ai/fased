...
import type { FasedAgentConfig, ReplyToMode } from "../config/config.js";
...
function isTelegramControlRequestText(
  ...
  if (isAbortRequestText(rawText, options)) {
    return true;
  }
...
export function getTelegramSequentialKey(ctx: {
  ...
  if (isTelegramControlRequestText(rawText, botUsername ? { botUsername } : undefined)) {
