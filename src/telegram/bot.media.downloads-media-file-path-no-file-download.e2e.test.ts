...
type ReplyModuleWithSpy = typeof import("../auto-reply/reply.js") & {
  __replySpy: ReturnType<typeof vi.fn>;
};

async function getReplySpy(): Promise<ReturnType<typeof vi.fn>> {
  const replyModule = (await import("../auto-reply/reply.js")) as ReplyModuleWithSpy;
  return replyModule.__replySpy;
}
...
async function createBotHandler(): Promise<{
  ...
  const replySpy = await getReplySpy();
