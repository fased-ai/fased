...
describe("createTelegramBot", () => {
  ...
  it("sequentializes updates by chat and thread", () => {
    ...
    expect(
      getTelegramSequentialKey({
        message: {
          chat: { id: 123, type: "supergroup", title: "Ops" },
          message_id: 1,
          date: 1,
          message_thread_id: 9,
        },
    ...
    expect(
      getTelegramSequentialKey({
        message: {
          chat: { id: 123, type: "supergroup", title: "Ops", is_forum: true },
          message_id: 1,
          date: 1,
        },
      }),
  ...
  it("requests pairing by default for unknown DM senders", async () => {
    ...
    expect(pairingText).toContain("fased pairing approve telegram PAIRME12");
