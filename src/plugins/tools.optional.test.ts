...
const loadFasedAgentPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadFasedAgentPlugins: (params: unknown) => loadFasedAgentPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadFasedAgentPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadFasedAgentPluginsMock.mockClear();
  });
