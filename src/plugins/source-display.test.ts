...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/fased/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fased/extensions",
        global: "/Users/x/.fased/extensions",
        workspace: "/Users/x/ws/.fased/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.fased/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fased/extensions",
        global: "/Users/x/.fased/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.fased/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/fased/extensions",
        global: "/Users/x/.fased/extensions",
