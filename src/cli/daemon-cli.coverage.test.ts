...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.FASED_STATE_DIR = "/tmp/fased-cli-state";
    process.env.FASED_CONFIG_PATH = "/tmp/fased-cli-state/fased.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        FASED_PROFILE: "dev",
        FASED_STATE_DIR: "/tmp/fased-daemon-state",
        FASED_CONFIG_PATH: "/tmp/fased-daemon-state/fased.json",
        FASED_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.fased.gateway.plist",
    });
