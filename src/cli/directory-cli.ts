    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["fased directory self --channel slack", "Show the connected account identity."],
          [
            'fased directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["fased directory groups list --channel discord", "List available groups/channels."],
          [
            "fased directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.fased.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
