...
const SANDBOX_EXAMPLES = {
  main: [
    ["fased sandbox list", "List all sandbox containers."],
    ["fased sandbox list --browser", "List only browser containers."],
    ["fased sandbox recreate --all", "Recreate all containers."],
    ["fased sandbox recreate --session main", "Recreate a specific session."],
    ["fased sandbox recreate --agent mybot", "Recreate agent containers."],
    ["fased sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["fased sandbox list", "List all sandbox containers."],
    ["fased sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["fased sandbox recreate --all", "Recreate all containers."],
    ["fased sandbox recreate --session main", "Recreate a specific session."],
    ["fased sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["fased sandbox recreate --browser --all", "Recreate only browser containers."],
    ["fased sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["fased sandbox explain", "Show effective sandbox config."],
    ["fased sandbox explain --session agent:main:main", "Explain a specific session."],
    ["fased sandbox explain --agent work", "Explain an agent sandbox."],
    ["fased sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.fased.ai/cli/sandbox")}\n`,
    )
    .action(() => {
