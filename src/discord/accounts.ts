...
function mergeDiscordAccountConfig(cfg: FasedAgentConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: FasedAgentConfig): ResolvedDiscordAccount[] {
