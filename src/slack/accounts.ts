...
function mergeSlackAccountConfig(cfg: FasedAgentConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: FasedAgentConfig): ResolvedSlackAccount[] {
