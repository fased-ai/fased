...
function resolveDefaultAccountId(cfg: FasedAgentConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: FasedAgentConfig): boolean {
...
export function summarizeBindings(cfg: FasedAgentConfig, bindings: AgentBinding[]): string[] {
