...
export function applyOpenAIProviderConfig(cfg: FasedAgentConfig): FasedAgentConfig {
...
export function applyOpenAIConfig(cfg: FasedAgentConfig): FasedAgentConfig {
