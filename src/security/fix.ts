...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FasedAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FasedAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: FasedAgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
