...
func TestGatewayReadinessBindsExactPackagedGeneration(t *testing.T) {
	...
	body := []byte(`{"ok":true,"ready":true,"status":"ready","version":"0.1.76","runtimeSource":"go-lifecycle","pid":123,"startedAt":"2026-08-13T12:00:00Z","generation":{"schemaVersion":1,"generationId":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","version":"0.1.76","releaseCommit":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"}}`)
	...
	wrongCommit := []byte(`{"ok":true,"ready":true,"status":"ready","version":"0.1.76","runtimeSource":"go-lifecycle","generation":{"schemaVersion":1,"version":"0.1.76","releaseCommit":"cccccccccccccccccccccccccccccccccccccccc"}}`)
