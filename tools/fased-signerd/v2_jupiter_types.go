...
const (
	...
	jupiterAggregatorV6V2  = "JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4" // pragma: allowlist secret
...
func isSupportedTriggerTransferProgramV2(program string) bool {
	return program == "11111111111111111111111111111111" ||
		program == "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA" || // pragma: allowlist secret
		program == "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb" // pragma: allowlist secret
}
